...
public void inicio(){
    ...
    private void initComponents() {
        ...
        setTitle("Filósofos Comiendo bocadillos");
        ...
        butFil1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel1.add(butFil1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 50, 110, 30));

        labTen1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        labTen1.setText("Ten1");
        jPanel1.add(labTen1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 130, -1, -1));

        labTen5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        labTen5.setText("Ten5");
        jPanel1.add(labTen5, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 130, -1, -1));

        labTen3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        labTen3.setText("Ten3");
        jPanel1.add(labTen3, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 230, -1, -1));

        butFil2.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        butFil2.setText("Filosofo2");
        butFil2.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel1.add(butFil2, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 170, 100, 30));

        labTen2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        labTen2.setText("Ten2");
        jPanel1.add(labTen2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 220, -1, -1));

        labTen4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        labTen4.setText("Ten4");
        jPanel1.add(labTen4, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 160, -1, -1));

        butFil3.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        butFil3.setText("Filosofo3");
        butFil3.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel1.add(butFil3, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 290, 100, 30));

        butFil4.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        butFil4.setText("Filosofo4");
        butFil4.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel1.add(butFil4, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 240, 100, 30));

        butFil5.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        butFil5.setText("Filosofo5");
        butFil5.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        butFil5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                butFil5ActionPerformed(evt);
            }
        });
        jPanel1.add(butFil5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 100, 40));

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel1.setText("Problema de Los Filósofos");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (i = 0; i < 5; i++) {
            ...
            com = new Cennas(i, tenedor[izq], tenedor[der], filosofo[i],resultado[i], tAreaProceso);
        }
    ...
    class FondoPanel extends JPanel {
        ...
        public void paint(Graphics g) {
            imagen = new ImageIcon(getClass().getResource("/Imagen/images.jpg")).getImage();
